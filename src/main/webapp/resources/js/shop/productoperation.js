...
$(function(){
	...
	// 更新商品信息的URL
	let productPostUrl = '/o2o/shopadmin/updateproduct';
	// 由于商品添加和修改使用的是同一个页面，该标识符用来标明本次是添加操作还是修改操作
//	let isEdit = shopId? true : false;
	...
	$("#submit").click(function(){
		...
		// 将product json 对象转成字符流保存至表单对象key为productStr的键值对里
